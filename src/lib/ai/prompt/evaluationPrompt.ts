...
export function buildEvaluationPrompt({ card, meaning, question, userAnswer }: EvaluationInput) {
  ...
  return [
    ...
    "traditional_correction의 ②는 반드시 ① 카드 의미 ② 질문 상황 ③ 질문자에게 어떻게 나타나는가 ④ 가장 핵심적으로 읽어야 하는 부분 순서로 이어지는 하나의 흐름이어야 한다.",
    "traditional_correction의 ②에는 '이 카드는 이 질문에서 무엇을 경계하는가', '무엇이 흐려져 있는가', '무엇이 가능하거나 어려운가', '무엇을 확인해야 하는가'처럼 실제 해석만 써라.",
    "traditional_correction의 ②에는 키워드 나열, 한 줄짜리 정의 반복, 교과서식 정의 나열을 쓰지 마라.",
    ...
    "sample_answer는 카드 의미를 현실 언어로 번역한 말이어야 하며, '주의해야 합니다', '판단해야 합니다', '역할의 전환을 의미합니다' 같은 딱딱한 문장을 쓰지 마라.",
